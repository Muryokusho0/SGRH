...
namespace SGRH.Application.UseCases.Reservas.ConfirmarReserva;

public sealed class ConfirmarReservaUseCase
{
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            // La entidad lanza BusinessRuleViolationException si no puede confirmarse
            reserva.Confirmar();
            ...
            await _auditoria.RegistrarAsync(new AuditoriaEvento(
                ...
                descripcion: $"Reserva {reserva.ReservaId} confirmada. CostoTotal: {reserva.CostoTotal:C}"), ct);
